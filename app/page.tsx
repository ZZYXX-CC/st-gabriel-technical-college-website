        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="group">
              <div className="relative overflow-hidden rounded-3xl bg-white/70 backdrop-blur-sm border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <div className="relative overflow-hidden">
                  <Image src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.0.3" alt="Annual Career Fair Success" width={600} height={300} className="w-full h-56 object-cover transition-transform duration-700 group-hover:scale-110" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                  <div className="absolute top-4 left-4">
                    <Badge className="bg-green-500/90 text-white border-0">Success Story</Badge>
                  </div>
                </div>
                <div className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-stg-sky-blue transition-colors duration-300">Annual Career Fair Success</h3>
                  <p className="text-stg-gray mb-6 leading-relaxed">Our annual career fair connected students with over 50 leading companies, resulting in numerous internship and job offers.</p>
                  <Button variant="ghost" className="text-stg-sky-blue hover:text-stg-sky-blue/80 hover:bg-stg-sky-blue/10 p-0 h-auto font-semibold group">Read More<ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" /></Button>
                </div>
              </div>
            </div>
            ...
            <div className="group">
              <div className="relative overflow-hidden rounded-3xl bg-white/70 backdrop-blur-sm border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <div className="relative overflow-hidden">
                  <Image src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.0.3" alt="Robotics Club Competition" width={600} height={300} className="w-full h-56 object-cover transition-transform duration-700 group-hover:scale-110" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                  <div className="absolute top-4 left-4">
                    <Badge className="bg-yellow-500/90 text-white border-0">Competition</Badge>
                  </div>
                </div>
                <div className="p-8">
                  <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-stg-sky-blue transition-colors duration-300">Robotics Club Competition</h3>
                  <p className="text-stg-gray mb-6 leading-relaxed">The St. Gabriel Robotics Club secured first place in the regional inter-school competition.</p>
                  <Button variant="ghost" className="text-stg-sky-blue hover:text-stg-sky-blue/80 hover:bg-stg-sky-blue/10 p-0 h-auto font-semibold group">View Details<ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" /></Button>
                </div>
              </div>
            </div>
            ...
            <div className="group">
              <div className="relative overflow-hidden rounded-3xl bg-white/70 backdrop-blur-sm border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <div className="relative overflow-hidden">
                  <Image src="https://images.unsplash.com/photo-1581092162384-8987c1d64718?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.0.3" alt="New HVAC Systems Lab Opens" width={600} height={300} className="w-full h-56 object-cover transition-transform duration-700 group-hover:scale-110" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                  <div className="absolute top-4 left-4">
                    <Badge className="bg-blue-500/90 text-white border-0">New Facility</Badge>
                  </div>
                </div>
                <div className="p-8">
                  <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-stg-sky-blue transition-colors duration-300">New HVAC Systems Lab Opens</h3>
                  <p className="text-stg-gray mb-6 leading-relaxed">Our state-of-the-art HVAC Systems Technology lab is now open, offering advanced training facilities.</p>
                  <Button variant="ghost" className="text-stg-sky-blue hover:text-stg-sky-blue/80 hover:bg-stg-sky-blue/10 p-0 h-auto font-semibold group">Discover More<ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" /></Button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <Button asChild size="lg" className="bg-stg-sky-blue hover:bg-stg-sky-blue/90 text-white px-12 py-4 text-lg font-semibold rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group">
              <Link href="/news-events" className="flex items-center gap-3">View All Updates<ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1" /></Link>
            </Button>
          </div>
        </div>
      </section>
