        ...
        <section className="mx-auto max-w-7xl px-4 py-16 text-slate-800">
          ...
          <div className="mb-8 grid grid-cols-12 gap-6">
            ...
            >
               <div className="absolute inset-0 bg-blue-500/5 border border-blue-300/15 rounded-2xl"></div>
                ...
                <div className="absolute bottom-0 left-4 right-4 top-28 translate-y-8 rounded-t-2xl bg-gradient-to-br from-blue-400/30 to-sky-400/30 backdrop-blur-[2px] p-4 transition-transform duration-&lsqb;250ms&rsqb; group-hover:translate-y-4 group-hover:rotate-[2deg]">
            ...
            >
              ...
              <CardTitle>
               ...
               <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-emerald-400/50 to-teal-400/50 backdrop-blur-sm p-4 transition-transform duration-&lsqb;250ms&rsqb; group-hover:translate-y-4 group-hover:rotate-[2deg]">
                <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            >
              ...
              <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-amber-400/30 to-orange-400/30 backdrop-blur-[2px] p-4 transition-transform duration-&lsqb;250ms&rsqb; group-hover:translate-y-4 group-hover:rotate-[2deg]">
                <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            >
              ...
              <div className="absolute bottom-0 left-4 right-4 top-32 translate-y-8 rounded-t-2xl bg-gradient-to-br from-rose-400/30 to-pink-400/30 backdrop-blur-[2px] p-4 transition-transform duration-&lsqb;250ms&rsqb; group-hover:translate-y-4 group-hover:rotate-[2deg]">
                <div className="flex flex-col items-center justify-center h-full text-center">
...
const BounceCard: React.FC<BounceCardProps> = ({ className, children, style }) => {
  return (
    <motion.div
      ...
      className={`group relative min-h-[300px] cursor-pointer overflow-hidden rounded-2xl bg-slate-100 p-8 will-change-transform ${className}`}
      style={style}
    >
      {children}
    </motion.div>
